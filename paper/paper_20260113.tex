...
Figure @ref(fig:fig-bo) summarises the optimisation run. Panel A uses
the Gaussian-process surrogate to show the BO posterior mean C-index
across \(k\) for the supervised and \(\alpha=0\) searches, with 90\%
confidence bands capturing model-based uncertainty beyond the sampled
runs. The final configuration of the supervised search converges to
\(k=3\) and \(\alpha=0.7\), which provided the highest cross-validated
C-index encountered by BO.
...
{\centering \includegraphics[width=6in,height=5.5in]{/work/users/a/y/ayoung31/DeSurv-paper/paper/paper_20260113_files/figure-latex/fig-bo-1} 

}

\caption{A. GP posterior mean and 90\% confidence bands of the CV C-index versus k for the supervised and $\alpha$ = 0 searches. B-D. Conventional NMF diagnostics (cophenetic, residuals, silhouette) for the unsupervised baseline.}\label{fig:fig-bo}
\end{figure*}
...
{\centering \includegraphics[width=\textwidth,height=4.5in]{/work/users/a/y/ayoung31/DeSurv-paper/paper/paper_20260113_files/figure-latex/fig-bio-1} 
...
{\centering \includegraphics[width=\textwidth,height=8in]{/work/users/a/y/ayoung31/DeSurv-paper/paper/paper_20260113_files/figure-latex/fig-sc-1} 
...
## Paper git commit: 4948add9c5eb241081d29f3b9ec1b73e8ad4d7db
\end{verbatim}
