...
\hypertarget{bayesian-optimisation-selects-the-desurv-hyperparameters-k-alpha}{%
...
{\centering \includegraphics[width=6in,height=5.5in]{../figures/fig_bo_tcgacptac} 

}

\caption{A. Best observed CV C-index versus k for the supervised and $\alpha$ = 0 searches with cross-validation SE error bars. B-D. Conventional NMF diagnostics (cophenetic, residuals, silhouette) for the unsupervised baseline.}\label{fig:fig-bo}
\end{figure*}
...
number of top genes per factor (\texttt{n_top}) using BO. We compared
...
{\centering \includegraphics[width=0.49\textwidth]{../figures/sim/bo_tune_ntop/sim_cindex_boxplot__combined} 

}

\caption{Simulation results for BO-tuned signature size. A. Test C-index across simulation regimes for DeSurv and the $\alpha=0$ baseline. B. Precision of recovered prognostic genes (mean across lethal factors).}\label{fig:fig-sim-ntop-1}
\end{figure*}
\begin{figure*}[t]

{\centering \includegraphics[width=0.49\textwidth]{../figures/sim/bo_tune_ntop/sim_precision_boxplot__combined} 

}

\caption{Simulation results for BO-tuned signature size. A. Test C-index across simulation regimes for DeSurv and the $\alpha=0$ baseline. B. Precision of recovered prognostic genes (mean across lethal factors).}\label{fig:fig-sim-ntop-2}
\end{figure*}

\hypertarget{desurv-provides-biologically-interpretable-gene-signatures}{%
...
{\centering \includegraphics[width=\textwidth,height=4.5in]{../figures/fig_bio_tcgacptac} 
...
\hypertarget{external-validation-with-projected-desurv-factor-scores}{%
...
{\centering \includegraphics[width=\textwidth,height=4in]{../figures/fig_extval_tcgacptac} 

}

\caption{External cohort validation. A. Heatmap of ranked expression values for genes in the selected DeSurv factor signatures with continuous factor-score annotations plus PurIST, DeCAF, and dataset labels. B. Scatter plot of the top two factor scores, colored by PurIST subtype and shaped by DeCAF subtype. C. Kaplan–Meier curves for the four groups formed by per-cohort median splits of the two factor scores.}\label{fig:fig-extval}
\end{figure*}

\hypertarget{bladder-cancer-analysis}{%
...
## Paper git commit: 3c19315d20fc8a6781219f6cb78abb81e8f7a4c5
\end{verbatim}
...
\emph{Journal of Thoracic Oncology} 16(Suppl 15):S539--S547.}

\leavevmode\vadjust pre{\hypertarget{ref-Planey2016}{}}%
\CSLLeftMargin{7. }
\CSLRightInline{Planey Catherine\,R, Gevaert O (2016) CoINcIDE: A
framework for discovery of patient subtypes across multiple datasets.
\emph{Genome Medicine} 8(1):27.}

\leavevmode\vadjust pre{\hypertarget{ref-Prat2014}{}}%
\CSLLeftMargin{8. }
\CSLRightInline{Prat A, Pineda E, Adamo B, et\,al. (2014) Molecular
features and survival outcomes of the intrinsic subtypes in the
...
\CSLLeftMargin{14. }
\CSLRightInline{Bailey P, Chang DK, et al. (2016) Genomic analyses
...
\leavevmode\vadjust pre{\hypertarget{ref-seung2001algorithms}{}}%
\CSLLeftMargin{19. }
...
\leavevmode\vadjust pre{\hypertarget{ref-pascualmontano2006nonsmooth}{}}%
\CSLLeftMargin{20. }
\CSLRightInline{Pascual-Montano A, Carazo JM, Kochi K, Lehmann D,
Pascual-Marqui RD (2006) Nonsmooth nonnegative matrix factorization.
\emph{IEEE Transactions on Pattern Analysis and Machine Intelligence}
28(3):403--415.}

\leavevmode\vadjust pre{\hypertarget{ref-simon2011regularization}{}}%
\CSLLeftMargin{21. }
...
\leavevmode\vadjust pre{\hypertarget{ref-lin2007convergence}{}}%
\CSLLeftMargin{22. }
...
\leavevmode\vadjust pre{\hypertarget{ref-tseng2001convergence}{}}%
\CSLLeftMargin{23. }
...
\leavevmode\vadjust pre{\hypertarget{ref-grippo2000convergence}{}}%
\CSLLeftMargin{24. }
...
\leavevmode\vadjust pre{\hypertarget{ref-donoho2004nmf}{}}%
\CSLLeftMargin{25. }
...
\leavevmode\vadjust pre{\hypertarget{ref-laurberg2008uniqueness}{}}%
\CSLLeftMargin{26. }
...
\leavevmode\vadjust pre{\hypertarget{ref-gillis2014nmf}{}}%
\CSLLeftMargin{27. }
...
\leavevmode\vadjust pre{\hypertarget{ref-kim2007sparse}{}}%
\CSLLeftMargin{29. }
...
\leavevmode\vadjust pre{\hypertarget{ref-gillis2012accelerated}{}}%
\CSLLeftMargin{30. }
...
\leavevmode\vadjust pre{\hypertarget{ref-cai2011graph}{}}%
\CSLLeftMargin{31. }
...
\leavevmode\vadjust pre{\hypertarget{ref-wang2014supervised}{}}%
\CSLLeftMargin{32. }
...
\leavevmode\vadjust pre{\hypertarget{ref-blei2007slda}{}}%
\CSLLeftMargin{33. }
