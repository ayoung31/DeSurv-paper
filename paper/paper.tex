...
reconstruction term conditional on \(W\) (21, 22). The
...
(21); for \(\alpha>0\), the Cox gradient perturbs the update in a
...
\left\{
  ...
  \right)
\right\}.
\] We solve this subproblem by cyclic coordinate descent following (23).
...
Cox log-partial likelihood (23). We iterate coordinate updates until the
...
\item
  ...
  coincide with the KKT points of this constrained subproblem (21, 24).
...
\item
  ...
  subproblem; see, for example, (25, 26). If \(W^*\) did not satisfy the
...
considered in block coordinate descent analyses such as (25). In this
...
solutions (27--29). Although normalizing columns of \(W\) or rows of
...
local minima than the program matrix \(W\) (30--32).
...
coefficient matrix modifies \(H\) but not the basis \(W\) (33--35).
