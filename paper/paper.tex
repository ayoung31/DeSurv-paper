...
replicates, DeSurv achieved median C-index \(0.837\) versus \(NA\) for
standard NMF (\(\Delta = NA\); \(p = 3{,}000\) genes, \(n = 200\)
samples, true \(k = 3\)).
...
{\centering \includegraphics[width=\textwidth,height=7in]{/work/users/a/y/ayoung31/DeSurv-paper/paper/paper_files/figure-latex/fig-bio-1} 
...
\(P = 0.78\); HR \(0.96\); 95\% CI \(0.71\)--\(1.29\)). This finding
...
## Paper git commit: 4f09064e7fe901a7d97ff38e0cdb445eb680d29f
\end{verbatim}
