...
Figure \ref{fig:bo} summarises the optimisation run. Panel A reports the
best observed cross-validated C-index at each \(k\) for the supervised
and \(\alpha=0\) searches, with error bars denoting the cross-validation
standard error across folds. The final configuration of the supervised
...
## Paper git commit: c44b35e6e577383115835cb1a64bf87833941061
\end{verbatim}
