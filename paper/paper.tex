...
replicates, DeSurv achieved median C-index \(0.842\) versus \(0.769\)
for standard NMF (\(\Delta = 0.073\); \(p = 3{,}000\) genes, \(n = 200\)
samples, true \(k = 3\)).
...
## Paper git commit: 24397d11ea164cc998496b5eb737e55248893630
\end{verbatim}
