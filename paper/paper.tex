...
Finally, to assess disease-specific structure, we fit DeSurv directly to
the bladder cancer cohort and examined the biological programs
associated with the resulting factors (Fig. \ref{fig:bladder}C). The
survival-associated DeSurv factor identified in bladder cancer
overlapped with established bladder tumor programs linked to aggressive
disease, while variance-dominant NMF factors were enriched for
transcriptional structure lacking consistent association with outcome.
As in PDAC, differentiation- and composition-related signals were
prominent among NMF components but were not isolated as dominant axes in
the survival-informed DeSurv solution.

Together, these results demonstrate that survival-informed factorization
both transfers prognostic structure across cancer types and adapts to
disease-specific biology when refit within a cohort. By deprioritizing
...
identifies latent structure that is robust across cancers while
remaining biologically interpretable within each disease context.
...
## Paper git commit: a0923dfce100c70f93f2d13a0d1d7682248f3e4f
\end{verbatim}
