...
likelihood gradients. This update can also be derived from projected
coordinate descent. \begin{align}
\label{W_update}
W^{(t+1)} = &W^{(t)} \odot \nonumber \\
...
\subsection*{Derivation of W update}\label{derivation-of-w-update}
\addcontentsline{toc}{subsection}{Derivation of W update}
...
\end{equation} which is the \(W\) update defined in \ref{W_update}.
