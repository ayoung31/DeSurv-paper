...
plot_4d <- fig_desurv_std_correlation_tcgacptac$plot
legend_4d <- fig_desurv_std_correlation_tcgacptac$legend

# Align 4A and 4B to identical height and width
aligned_ab <- cowplot::align_plots(plot_4a, plot_4b, align = "hv", axis = "tblr")

# Left block: 4A, 4B, then shared legend to the right (legend gets ~10% of width)
...
bottom_right = plot_grid(NULL,plot_4d,ncol=2,rel_widths = c(1,4))

right = plot_grid(fig_variation_explained_tcgacptac +
                    theme(
                      legend.position = c(1, 0.5),    # x, y in [0,1]
