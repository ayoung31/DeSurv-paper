...
tar_load(fig_median_survival_std_elbowk_tcgacptac)
...
aligned_ab <- cowplot::align_plots(plot_4a, plot_4b, align = "hv", axis = "tblr")

left_block <- plot_grid(
  aligned_ab[[1]], aligned_ab[[2]], cowplot::ggdraw(legend_4ab),
  ncol = 3, labels = c("A", "B", ""),
...
med_std    <- fig_median_survival_std_elbowk_tcgacptac
