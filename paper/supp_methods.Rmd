...
programs from the deCAF study [CITE]; SCISSORS PDAC subtypes [CITE]; tumor,
...
SI Appendix, Fig.\ \ref{fig:varsurvival}.
...
heatmap with NMF factors as rows and DeSurv factors as columns (Fig.\ \ref{fig:bio}C).
