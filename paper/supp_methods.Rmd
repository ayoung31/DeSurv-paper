...
[@lee2001algorithms; @pascualmontano2006nonsmooth]. The $\varepsilon_H$-floor
...
to the standard multiplicative update for NMF [@lee2001algorithms];
...
[@simon2011]. Writing $\ell(\beta) = \ell(W,\beta)$ and
...
quadratic approximations of the Cox log-partial likelihood [@simon2011].
...
constrained subproblem [@lee2001algorithms; @lin2007multconv]. Since the full
...
the constrained subproblem; see, for example, [@tseng2001; @grippo2000].
...
form considered in block coordinate descent analyses such as [@tseng2001].
