...
# Load helper functions for validation data preprocessing and figure generation
source("R/targets_config.R")
source("R/figure_targets.R")


# Sim results from student's HPC store (too large to rebuild locally)
sim_figs_by_scenario <- readRDS(file.path(params$tar_store, "objects", "sim_figs_by_scenario"))
...
raw_data_bladder <- "data/original/IMVigor210_sampInfo_ex_clinical.rds"
