...
best_params <- tar_read(resolve_target_name(
  "tar_params_best",
  bo_label = bo_label,
...
```{r fig-bo, fig.width = 6, fig.height= 5.5, fig.cap="A. GP posterior mean and 90% confidence bands of the CV C-index versus k for the supervised and $\\alpha$ = 0 searches. B-D. Conventional NMF diagnostics (cophenetic, residuals, silhouette) for the unsupervised baseline." , fig.env='figure*', fig.pos='t', out.height= "5.5in", out.width="6in"}

fig_bo_plot <- tar_read(resolve_target_name(
  "fig_bo_plot",
  bo_label = bo_label,
  run_label = run_label,
  available = available_targets
...
fig_bio_plot <- tar_read(resolve_target_name(
  "fig_bio_plot",
  bo_label = bo_label,
  run_label = run_label,
  available = available_targets
...
fig_sc_plot <- tar_read(resolve_target_name(
  "fig_sc_plot",
  bo_label = bo_label,
  run_label = run_label,
  available = available_targets
