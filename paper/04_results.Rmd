...
tar_load(fig_bo_cvk_tcgacptac)
tar_load(fig_bo_cvalpha_tcgacptac)
...
lower = plot_grid(fig_residuals_tcgacptac,fig_cophenetic_tcgacptac,fig_silhouette_tcgacptac,ncol = 3,labels = c("C","D","E"))
