...
analysis (SI Appendix, Table S3). Gene expression data and molecular
...
heatmap with NMF factors as rows and DeSurv factors as columns (main text, Fig.\ 3D).
