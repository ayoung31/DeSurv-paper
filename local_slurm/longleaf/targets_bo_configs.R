...
# Full HPC-quality iterations with Longleaf resources:
#   - ninit = 50: Full random initializations during BO CV
#   - desurv_ncores_grid = 50: Matches 50 CPUs per BO worker on Longleaf
#   - bo_n_init = 50/20: Full initial BO sample points
#   - bo_n_iter = 100/50: Full BO optimization iterations
#
...
targets_bo_configs <- function() {
  list(
    ...
    tcgacptac = list(
      ...
      lambdaw_config = c(0),
      lambdah_config = c(0),
      ninit = 50,  # Longleaf: 50 CPUs per BO worker
      bo_n_init = 50,
      bo_n_iter = 100,
      ...
      desurv_ncores_grid = 50  # Longleaf: 50 CPUs per BO worker
    ),
